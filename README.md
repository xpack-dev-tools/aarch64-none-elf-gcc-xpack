...
[project website](https://xpack-dev-tools.github.io/aarch64-none-elf-gcc-xpack/).

## Project source

The source code of the current release is available on
GitHub as [xpack-dev-tools/aarch64-none-elf-gcc-xpack](https://github.com/xpack-dev-tools/aarch64-none-elf-gcc-xpack),
the [v15.2.1-1.1.1](https://github.com/xpack-dev-tools/aarch64-none-elf-gcc-xpack/tree/v15.2.1-1.1.1) tree.
