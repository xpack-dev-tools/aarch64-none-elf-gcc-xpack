...
```console
$ tree -L 2 /Users/ilg/Library/xPacks/\@xpack-dev-tools/aarch64-none-elf-gcc/13.2.1-1.1/.content/
/Users/ilg/Library/xPacks/\@xpack-dev-tools/aarch64-none-elf-gcc/13.2.1-1.1/.content/
├── README.md
├── aarch64-none-elf
│   ├── bin
│   ├── include
...
like `13.2.1`; to this string the xPack distribution adds a four number,
but since semver allows only three numbers, all additional ones can
be added only as pre-release strings, separated by a dash,
like `13.2.1-2`.
When published as a npm package, the version gets
a fifth number, like `13.2.1-1.1`.

Since adherence of third party packages to semver is not guaranteed,
it is recommended to use semver expressions like `^13.2.1` and `~13.2.1`
with caution, and prefer exact matches, like `13.2.1-1.1`.
