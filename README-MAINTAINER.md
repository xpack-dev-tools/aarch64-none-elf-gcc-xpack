...
```sh
rm -rf ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git && \
git clone https://github.com/xpack-dev-tools/aarch64-none-elf-gcc-xpack.git \
  ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git
```
...
```sh
git -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git pull
```
...
file; the format is `12.2.1-1.2`. The fourth number is the Arm release
...
and fix them; assign them to a milestone (like `12.2.1-1.2`).
...
Update both full 5 numbers (`12.2.1-1.2`) and short 3 numbers (`12.2.1`)
versions in:
...
- add a new entry like _* v12.2.1-1.2 prepared_
- commit with a message like _prepare v12.2.1-1.2_
...
xpm run deep-clean -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git
```
...
```sh
xpm run install -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git
```
...
xpm run link-deps -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git
```
...
```sh
xpm run deep-clean --config darwin-x64  -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git

xpm install --config darwin-x64 -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git
```

Run the native build:

```sh
xpm run build-develop --config darwin-x64 -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git
```
...
```console
$ ls -l ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git/build/darwin-x64/deploy
total 231080
-rw-r--r--  1 ilg  staff  115138684 Feb  1 22:19 xpack-aarch64-none-elf-gcc-12.2.1-1.2-darwin-x64.tar.gz
-rw-r--r--  1 ilg  staff        122 Feb  1 22:19 xpack-aarch64-none-elf-gcc-12.2.1-1.2-darwin-x64.tar.gz.sha
```
...
xpm link -C ~/Work/xpacks/xbb-helper-xpack.git && \
xpm run link-deps -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git && \
xpm run deep-clean --config darwin-arm64  -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git && \
xpm install --config darwin-arm64 -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git
xpm run build-develop --config darwin-arm64 -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git
```
...
```console
$ ls -l ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git/build/darwin-arm64/deploy
total 230280
-rw-r--r--  1 ilg  staff  112123545 Feb  1 22:19 xpack-aarch64-none-elf-gcc-12.2.1-1.2-darwin-arm64.tar.gz
-rw-r--r--  1 ilg  staff        124 Feb  1 22:19 xpack-aarch64-none-elf-gcc-12.2.1-1.2-darwin-arm64.tar.gz.sha
```
...
xpm link -C ~/Work/xpacks/xbb-helper-xpack.git && \
xpm run link-deps -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git && \
xpm run deep-clean --config linux-x64 -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git && \
xpm run docker-prepare --config linux-x64 -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git && \
xpm run docker-link-deps --config linux-x64 -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git
xpm run docker-build-develop --config linux-x64 -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git
```
...
```console
$ ls -l ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git/build/linux-x64/deploy
total 119720
-rw-r--r-- 1 ilg ilg 122589099 Feb  1 19:58 xpack-aarch64-none-elf-gcc-12.2.1-1.2-linux-x64.tar.gz
-rw-r--r-- 1 ilg ilg       121 Feb  1 19:58 xpack-aarch64-none-elf-gcc-12.2.1-1.2-linux-x64.tar.gz.sha
```
...
xpm link -C ~/Work/xpacks/xbb-helper-xpack.git && \
xpm run link-deps -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git && \
xpm run deep-clean --config win32-x64 -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git && \
xpm run docker-prepare --config win32-x64 -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git && \
xpm run docker-link-deps --config win32-x64 -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git
xpm run docker-build-develop --config win32-x64 -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git
```
...
```console
$ ls -l ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git/build/win32-x64/deploy
total 117336
-rw-r--r-- 1 ilg ilg 120144861 Feb  1 19:51 xpack-aarch64-none-elf-gcc-12.2.1-1.2-win32-x64.zip
-rw-r--r-- 1 ilg ilg       118 Feb  1 19:51 xpack-aarch64-none-elf-gcc-12.2.1-1.2-win32-x64.zip.sha
```
...
xpm link -C ~/Work/xpacks/xbb-helper-xpack.git && \
xpm run link-deps -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git && \
xpm run deep-clean --config linux-arm64 -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git && \
xpm run docker-prepare --config linux-arm64 -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git && \
xpm run docker-link-deps --config linux-arm64 -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git
xpm run docker-build-develop --config linux-arm64 -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git
```
...
```console
$ ls -l ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git/build/linux-arm64/deploy
total 169440
-rw-rw-rw- 1 root root 94181557 Aug 21 05:04 xpack-aarch64-none-elf-gcc-12.2.1-1.2-linux-arm64.tar.gz
-rw-rw-rw- 1 root root      106 Aug 21 05:04 xpack-aarch64-none-elf-gcc-12.2.1-1.2-linux-arm64.tar.gz.sha
```
...
xpm link -C ~/Work/xpacks/xbb-helper-xpack.git && \
xpm run link-deps -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git && \
xpm run deep-clean --config linux-arm -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git && \
xpm run docker-prepare --config linux-arm -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git && \
xpm run docker-link-deps --config linux-arm -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git
xpm run docker-build-develop --config linux-arm -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git
```
...
```console
$ ls -l ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git/build/linux-arm/deploy
total 97460
-rw-r--r-- 1 ilg ilg 99793275 Dec 11 15:51 xpack-aarch64-none-elf-gcc-12.2.1-1.2-linux-arm64.tar.gz
-rw-r--r-- 1 ilg ilg      120 Dec 11 15:51 xpack-aarch64-none-elf-gcc-12.2.1-1.2-linux-arm64.tar.gz.sha
```
...
```sh
bash ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git/xpacks/xpack-dev-tools-xbb-helper/github-actions/trigger-workflow-build.sh --machine xbbli
bash ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git/xpacks/xpack-dev-tools-xbb-helper/github-actions/trigger-workflow-build.sh --machine xbbla64
bash ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git/xpacks/xpack-dev-tools-xbb-helper/github-actions/trigger-workflow-build.sh --machine xbbla32
bash ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git/xpacks/xpack-dev-tools-xbb-helper/github-actions/trigger-workflow-build.sh --machine xbbmi
bash ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git/xpacks/xpack-dev-tools-xbb-helper/github-actions/trigger-workflow-build.sh --machine xbbma
```
...
```sh
bash ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git/xpacks/xpack-dev-tools-xbb-helper/github-actions/trigger-workflow-test-prime.sh
bash ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git/xpacks/xpack-dev-tools-xbb-helper/github-actions/trigger-workflow-test-docker-linux-intel.sh
bash ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git/xpacks/xpack-dev-tools-xbb-helper/github-actions/trigger-workflow-test-docker-linux-arm.sh
```
...
```sh
bash ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git/xpacks/xpack-dev-tools-xbb-helper/github-actions/trigger-travis-macos.sh
```
...
git -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git pull
xpm run install -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git
xpm run test-pre-release -C ~/Work/xpacks/aarch64-none-elf-gcc-xpack.git
```
...
- in `CHANGELOG.md`, add the release date and a message like _* v12.2.1-1.2 released_
...
tagged like **v12.2.1-1.2** (mind the dash in the middle!) and
named like **xPack GNU AArch64 Embedded GCC v12.2.1-1.2** (mind the dash),
...
- commit the `develop` branch of `xpack/web-jekyll` GitHub repo;
  use a message like _xPack GNU AArch64 Embedded GCC v12.2.1-1.2 released_
- push to GitHub
...
- commit all changes, use a message like
  _package.json: update urls for 12.2.1-1.2 release_ (without _v_)

## Publish on the npmjs.com server

- select the `xpack-develop` branch
- check the latest commits `npm run git-log`
- update `CHANGELOG.md`, add a line like _* v12.2.1-1.2.1 published on npmjs.com_
- commit with a message like _CHANGELOG: publish npm v12.2.1-1.2.1_
- `npm pack` and check the content of the archive, which should list
  only the `package.json`, the `README.md`, `LICENSE` and `CHANGELOG.md`;
  possibly adjust `.npmignore`
- `npm version 12.2.1-1.2.1`; the first 5 numbers are the same as the
...
- `npm dist-tag add @xpack-dev-tools/aarch64-none-elf-gcc@12.2.1-1.2.1 latest`
- `npm dist-tag ls @xpack-dev-tools/aarch64-none-elf-gcc`

In case the previous version is not functional and needs to be unpublished:

- `npm unpublish @xpack-dev-tools/aarch64-none-elf-gcc@12.2.1-1.2.1`
...
- paste the release name like **xPack GNU AArch64 Embedded GCC v12.2.1-1.2 released**
...
- content:
  ...
  - The latest release is [12.2.1-1.2]() following Arm release from October 21, 2021 (version 10.3-2021.10).
