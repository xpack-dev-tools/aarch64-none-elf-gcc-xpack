...
xpm run deep-clean -C ~/Work/xpack-dev-tools/aarch64-none-elf-gcc-xpack.git
```
...
bash ~/Work/xpack-dev-tools/aarch64-none-elf-gcc-xpack.git/xpacks/xpack-dev-tools-xbb-helper/github-actions/trigger-workflow-build.sh --machine xbbla64
