...
Use the new version, suffixed by `pre`, like `13.2.1-1.1.pre`.
...
```sh
bash ~/Work/xpack-dev-tools/aarch64-none-elf-gcc-xpack.git/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-workflow-build.sh --workflow build-darwin-x64.yml
bash ~/Work/xpack-dev-tools/aarch64-none-elf-gcc-xpack.git/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-workflow-build.sh --workflow build-darwin-arm64.yml
bash ~/Work/xpack-dev-tools/aarch64-none-elf-gcc-xpack.git/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-workflow-build.sh --workflow build-linux-x64.yml
bash ~/Work/xpack-dev-tools/aarch64-none-elf-gcc-xpack.git/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-workflow-build.sh --workflow build-win32-x64.yml
bash ~/Work/xpack-dev-tools/aarch64-none-elf-gcc-xpack.git/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-workflow-build.sh --workflow build-linux-arm64.yml
bash ~/Work/xpack-dev-tools/aarch64-none-elf-gcc-xpack.git/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-workflow-build.sh --workflow build-linux-arm.yml
```
...
bash ~/Work/xpack-dev-tools/aarch64-none-elf-gcc-xpack.git/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-workflow-test-docker-linux-x64.sh
...
named like **xPack GNU AArch64 Embedded GCC v13.2.1-1.1** (mind the dash),
...
- commit the `develop` branch of `xpack/web-jekyll` GitHub repo;
  use a message like _xPack GNU AArch64 Embedded GCC v13.2.1-1.1 released_
- push to GitHub
...
- `npm dist-tag add @xpack-dev-tools/aarch64-none-elf-gcc@13.2.1-1.1.1 latest`
- `npm dist-tag ls @xpack-dev-tools/aarch64-none-elf-gcc`

In case the previous version is not functional and needs to be unpublished:

- `npm unpublish @xpack-dev-tools/aarch64-none-elf-gcc@13.2.1-1.1.1`
...
- paste the release name like **xPack GNU AArch64 Embedded GCC v13.2.1-1.1 released**
...
- content:
  ...
  - The latest release is [13.2.1-1.1]() following Arm release from October 21, 2021 (version 10.3-2021.10).
