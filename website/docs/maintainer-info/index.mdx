...
title: Information for xPack GNU AArch64 Embedded GCC maintainers
...
```sh
bash ~/Work/xpack-dev-tools/aarch64-none-elf-gcc-xpack.git/build-assets/xpacks/@xpack-dev-tools/xbb-helper/github-actions/trigger-travis-macos.sh
```
...
named like **xPack GNU AArch64 Embedded GCC v{ customField('upstreamVersion') }-{ customField('xpackSubversion') }** (mind the dash),
...
- <code>npm dist-tag ls @xpack-dev-tools/aarch64-none-elf-gcc</code>
- <code>npm dist-tag add @xpack-dev-tools/aarch64-none-elf-gcc@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') } latest</code>
- <code>npm dist-tag ls @xpack-dev-tools/aarch64-none-elf-gcc</code>

In case the previous version is not functional and needs to be unpublished:

- <code>npm unpublish @xpack-dev-tools/aarch64-none-elf-gcc@{ customField('upstreamVersion') }-{ customField('xpackSubversion') }.{ customField('npmSubversion') }</code>
...
- the result is in https://xpack-dev-tools.github.io/aarch64-none-elf-gcc-xpack/blog/
...
- paste the release name like _**xPack GNU AArch64 Embedded GCC v{ customField('upstreamVersion') }-{ customField('xpackSubversion') } released**_
