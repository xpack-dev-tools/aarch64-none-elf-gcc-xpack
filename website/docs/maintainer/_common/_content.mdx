...
(such as **14.2.1-1.1.1**) with the following expression:
...
- In `CHANGELOG.md`, add the release date and a message
  such as _**\* v14.2.1-1.1 released**_
...
tagged such as **v14.2.1-1.1** (mind the dash in the middle!) and
named such as **xPack GNU AArch64 Embedded GCC v14.2.1-1.1** (mind the dash),
