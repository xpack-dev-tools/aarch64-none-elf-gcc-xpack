...
- <code>xpack-aarch64-none-elf-gcc-15.2.1-1.1-{props.platform}.{props.platform === 'win32-x64' ? 'zip' : 'tar.gz'}</code>
- <code>xpack-aarch64-none-elf-gcc-15.2.1-1.1-{props.platform}.{props.platform === 'win32-x64' ? 'zip' : 'tar.gz'}.sha</code>
