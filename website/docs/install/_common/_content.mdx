...
The **xPack GNU AArch64 Embedded GCC** may be installed automatically, utilising the `xpm` command
(the recommended method), or manually, by downloading and unpacking one of the
platform-specific archives.

## Automated installation

The easiest (and recommended) method to install xPack GNU AArch64 Embedded GCC
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/@xpack-dev-tools/aarch64-none-elf-gcc/15.2.1-1.1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/@xpack-dev-tools/aarch64-none-elf-gcc/15.2.1-1.1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/aarch64-none-elf-gcc/15.2.1-1.1.1/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-aarch64-none-elf-gcc-15.2.1-1.1-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\aarch64-none-elf-gcc\\xpack-aarch64-none-elf-gcc-15.2.1-1.1</code>.
...
<ul>
<li><code>xpack-aarch64-none-elf-gcc-15.2.1-1.1-darwin-x64.tar.gz</code></li>
<li><code>xpack-aarch64-none-elf-gcc-15.2.1-1.1-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/aarch64-none-elf-gcc/xpack-aarch64-none-elf-gcc-15.2.1-1.1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/aarch64-none-elf-gcc
cd ~/Library/xPacks/aarch64-none-elf-gcc

tar xvf ~/Downloads/xpack-aarch64-none-elf-gcc-15.2.1-1.1-darwin-x64.tar.gz
chmod -R -w xpack-aarch64-none-elf-gcc-15.2.1-1.1
`} </CodeBlock>
...
<ul>
<li><code>xpack-aarch64-none-elf-gcc-15.2.1-1.1-linux-x64.tar.gz</code></li>
<li><code>xpack-aarch64-none-elf-gcc-15.2.1-1.1-linux-arm64.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/aarch64-none-elf-gcc/xpack-aarch64-none-elf-gcc-15.2.1-1.1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/aarch64-none-elf-gcc
cd ~/.local/xPacks/aarch64-none-elf-gcc

tar xvf ~/Downloads/xpack-aarch64-none-elf-gcc-15.2.1-1.1-linux-x64.tar.gz
chmod -R -w xpack-aarch64-none-elf-gcc-15.2.1-1.1
`} </CodeBlock>
