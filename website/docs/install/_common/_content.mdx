...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/@xpack-dev-tools/aarch64-none-elf-gcc/14.2.1-1.1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/@xpack-dev-tools/aarch64-none-elf-gcc/14.2.1-1.1.1/.content/bin:$PATH
`} </CodeBlock>
