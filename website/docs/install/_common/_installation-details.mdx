...
* identify the platform specific archive for the desired version
  of @xpack-dev-tools/aarch64-none-elf-gcc, download it into a cache and unpack
...
* add <code>@xpack-dev-tools/aarch64-none-elf-gcc</code> to
  `package.json` as a
  development dependency; this associates a specific version of the xPack GNU AArch64 Embedded GCC with
