...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/aarch64-none-elf-gcc /${customField('upstreamVersion')}-${customField('xpackSubversion')}.${customField('npmSubversion')}/.content/bin:$PATH`
} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/aarch64-none-elf-gcc /${customField('upstreamVersion')}-${customField('xpackSubversion')}.${customField('npmSubversion')}/.content/bin:$PATH`
} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/aarch64-none-elf-gcc /${customField('upstreamVersion')}-${customField('xpackSubversion')}.${customField('npmSubversion')}/.content/bin:$PATH`
} </CodeBlock>
...
* <code>xpack-aarch64-none-elf-gcc-{customField('upstreamVersion')}-{customField('xpackSubversion')}-win32-x64.zip</code>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\aarch64-none-elf-gcc\\xpack-aarch64-none-elf-gcc-{customField('upstreamVersion')}-{customField('xpackSubversion')}</code>.
...
* <code>xpack-aarch64-none-elf-gcc-{customField('upstreamVersion')}-{customField('xpackSubversion')}-darwin-x64.tar.gz</code>
* <code>xpack-aarch64-none-elf-gcc-{customField('upstreamVersion')}-{customField('xpackSubversion')}-darwin-arm64.tar.gz</code>
...
example <code>/Users/ilg/Library/xPacks/aarch64-none-elf-gcc/xpack-aarch64-none-elf-gcc-{customField('upstreamVersion')}-{customField('xpackSubversion')}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/aarch64-none-elf-gcc
cd ~/Library/xPacks/aarch64-none-elf-gcc

tar xvf ~/Downloads/xpack-aarch64-none-elf-gcc-${customField('upstreamVersion')}-${customField('xpackSubversion')}-darwin-x64.tar.gz
chmod -R -w xpack-aarch64-none-elf-gcc-${customField('upstreamVersion')}-${customField('xpackSubversion')}`
} </CodeBlock>
...
* <code>xpack-aarch64-none-elf-gcc-{customField('upstreamVersion')}-{customField('xpackSubversion')}-darwin-x64.tar.gz</code>
* <code>xpack-aarch64-none-elf-gcc-{customField('upstreamVersion')}-{customField('xpackSubversion')}-darwin-arm64.tar.gz</code>
* <code>xpack-aarch64-none-elf-gcc-{customField('upstreamVersion')}-{customField('xpackSubversion')}-darwin-arm.tar.gz</code>
...
example <code>/home/ilg/.local/xPacks/aarch64-none-elf-gcc/xpack-aarch64-none-elf-gcc-{customField('upstreamVersion')}-{customField('xpackSubversion')}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/aarch64-none-elf-gcc
cd ~/.local/xPacks/aarch64-none-elf-gcc

tar xvf ~/Downloads/xpack-aarch64-none-elf-gcc-${customField('upstreamVersion')}-${customField('xpackSubversion')}-linux-x64.tar.gz
chmod -R -w xpack-aarch64-none-elf-gcc-${customField('upstreamVersion')}-${customField('xpackSubversion')}`
} </CodeBlock>
