...
across different environments. In other words, if repeated after some
time, possibly on a different machine or platform, the resulting
behavior must be functionally equivalent.
...
In short, xPacks are just a way to automate installing the source and
especially the binary packages.
