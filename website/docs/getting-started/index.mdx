...
**xPacks** (short for **xpm packets**) are general-purpose,
language-neutral software packages.

<details>
<summary>What the heck are xPacks? Please, not yet another package format!</summary>

No, the xPacks Framework **does NOT introduce a new package format**; instead,
...
There is no magic behind **xpm**, for binary xPacks
operates straightforwardly by
unpacking platform-specific archives into distinct directories and then
creating links in the project to the corresponding executables.

Simply put, xPacks can further automate the installation of source
libraries and tools.
