...
There is no magic behind **xpm**. For binary xPacks, it simply
unpacks platform-specific archives into distinct directories and
then creates links in the project to the corresponding executables.
