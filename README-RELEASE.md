...
file; the format is `11.2.1-1.2`. The fourth number is the Arm release
...
and fix them; assign them to a milestone (like `11.2.1-1.2`).
...
Update both full 5 numbers (`11.2.1-1.2`) and short 3 numbers (`11.2.1`)
versions in:
...
- add a new entry like _- v11.2.1-1.2 prepared_
- commit with a message like _prepare v11.2.1-1.2_
...
- in `CHANGELOG.md`, add the release date and a message like _- v11.2.1-1.2 released_
...
tagged like **v11.2.1-1.2** (mind the dash in the middle!) and
named like **xPack GNU AArch64 Embedded GCC v11.2.1-1.2** (mind the dash),
...
- commit the `develop` branch of `xpack/web-jekyll` GitHub repo;
  use a message like **xPack GNU AArch64 Embedded GCC v11.2.1-1.2 released**
- push to GitHub
...
- commit all changes, use a message like
  `package.json: update urls for 11.2.1-1.2 release` (without `v`)
...
- `npm dist-tag add @xpack-dev-tools/aarch64-none-elf-gcc@11.2.1-1.2.2 latest`
- `npm dist-tag ls @xpack-dev-tools/aarch64-none-elf-gcc`

In case the previous version is not functional and needs to be unpublished:

- `npm unpublish @xpack-dev-tools/aarch64-none-elf-gcc@11.2.1-1.2.X`
...
- paste the release name like **xPack GNU AArch64 Embedded GCC v11.2.1-1.2 released**
...
- content:
  ...
  - The latest release is [11.2.1-1.2]() following Arm release from October 21, 2021 (version 10.3-2021.10).
